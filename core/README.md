...
### 1. Запуск API для работы сервиса
...
Это вариант запустит api, после него следуйте инструкциям в папке `/service`/

### 2. Базовый способ: локальная инициализация
